 ...
 * @author Peter
 */
@WebServlet(urlPatterns={"/GuardarNuevoPlato"})
public class GuardarNuevoPlato extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String consulta = "INSERT INTO ewaiter.Producto (ID_Subcategoria, Nombre, Descripcion, Ingredientes, Precio) VALUES ((SELECT ID_Subcategoria FROM ewaiter.Subcategoria WHERE Nombre LIKE '%"+subcategoria+"%'), '"+nombre+"', '"+descripcion+"', '"+ingredientes+"', "+precio+");";
